...
.
├── src/
│   ├── Mainn.java                  # Application principale avec GUI
│   ├── AnalyseurLexical.java       # Analyseur lexical
│   ├── AnalyseurSyntaxique.java    # Analyseur syntaxique
│   ├── Token.java                  # Classe Token
│   ├── TokenType.java              # Énumération des types de jetons
│   └── Rapport de Projet.pdf       # Rapport de projet
├── mini-compilateur-trycatch-php.jar  # Exécutable compilé
├── Rapport de Projet.pdf           # Rapport de projet (copie à la racine)
